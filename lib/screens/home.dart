...
class HomeScreen extends StatelessWidget {
  ...
  TabBar _tab() {
    return TabBar(unselectedLabelColor: text,
  ...
  BottomNavigationBarItem _bottomBarItem({required String icon , required String label}) => BottomNavigationBarItem(
